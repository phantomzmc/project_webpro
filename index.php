            ...
            <div class="navbar navbar-inverse navbar-fixed-top" role="navigation" id="top-nav">
                <div class="container">
                    <div class="navbar-header">
                        <!-- Logo Starts -->
                        <a class="navbar-brand" href="login.php"><img src="images/logo.png" alt="logo"></a>
                        <!-- #Logo Ends -->
                ...
                <span class="icon-bar"></span>
                    ...
                    <div class="navbar-collapse  collapse">
                        <ul class="nav navbar-nav navbar-right">
                            <li class="active"><a href="#home">หน้าเเรก</a></li>
                            <li><a href="#menu">สาระ</a></li>
                            <li><a href="#foods">กาเเฟ</a></li>
                            <li><a href="#partners">เเผนที่</a></li>
            ...
            <div class="caption">
                <div class="caption-wrapper">
                    <div class="caption-info">
                        ...
                        <h1 class="animated bounceInUp">นานาสาระกาเเฟ</h1>
    ...
    <div id="menu" class="container spacer about">
        ...
        <div class="row">
            <div class="col-sm-6 wowload fadeInLeft">
                ...
                <p>Creative digital agency for sleek and sophisticated solutions for mobile, websites and software designs, lead by passionate and uber progressive team that lives and breathes design. Creative digital agency for sleek and sophisticated solutions
                    for mobile, websites and software designs.</p>
                        ...
                        <div id="collapseOne" class="panel-collapse collapse" role="tabpanel">
                            <div class="panel-body">
                                <div class="clearfix food-list">
                                    <div class="pull-left">Tea/Coffee</div><span class="pull-right">$ 10.00</span></div>
                                <div class="clearfix food-list">
                                    <div class="pull-left">Tea/Coffee</div><span class="pull-right">$ 10.00</span></div>
                                <div class="clearfix food-list">
                                    <div class="pull-left">Tea/Coffee</div><span class="pull-right">$ 10.00</span></div>
                ...
                <div id="carousel-testimonials" class="carousel slide testimonails  wowload fadeInRight" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="item active animated bounceInRight row">
                            ...
                            <div class="col-xs-10">
                                <p> I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth,
